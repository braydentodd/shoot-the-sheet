...
opp_player: events where team_id != ext_team_id and in between a sub_in and sub_out player event
on_player: events where team_id = ext_team_id and in between a sub_in and sub_out player event
